...
public class ProductDAOImpl implements ProductDAO{
	...
	private static final String queryGetList = "from Product p LEFT JOIN FETCH p.orderProducts op order by idProduct";
	@Override
	@Transactional
	...
	private static final String queryGetObjByCode = "from Product p LEFT JOIN FETCH p.orderProducts op where codeProduct=:codeProduct";
	@Transactional
	@Override
	...
	private static final String queryGetObjByCodeAndStock = "from Product p LEFT JOIN FETCH p.orderProducts op where codeProduct=:codeProduct AND numStock=:stock";
	@Transactional
	@Override
