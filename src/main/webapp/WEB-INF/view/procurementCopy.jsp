...
<body>
		...
		<div class="card">
			<form id="orderForm" action="" method="post">
				<div class="card-header d-flex justify-content-between">
					<h3 id="formName" class="mb-0">Форма создания заявки</h3>
	...
	<!-- Контейнер с точками маршрута -->
					...
					<div class="input-row-container mt-3 pl-3">
	...
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/js/procurementCopyImport.js" type="module"></script>
