    ...
    public void saveOrUpdateUser(User user, int idRole) {
        ...
        switch (idRole) {
            ...
            case 16: //Роль для наблюдателя за всей системой без возможности внесение каких либо данных
                ...
                break;
            case 17: //Роль закупок отдела качества
                user.setEnablet(true);
                user.setIsDriver(false);
                user.setStatus("0");
                role = roleDAO.getRole(17);
                rolest.add(role);
                user.setRoles(rolest);
                user.setCompanyName("Доброном");
                if (user.getPassword() != null) {
            ...
            case 18: //Роль закупок отдела качества и обычного закупера
                user.setEnablet(true);
                user.setIsDriver(false);
                user.setStatus("0");
                role = roleDAO.getRole(18);
                rolest.add(role);
                user.setRoles(rolest);
                user.setCompanyName("Доброном");
                if (user.getPassword() != null) {
                ...
                break;
            case 19: //Роль отдела розничной торговли
                user.setEnablet(true);
                user.setIsDriver(false);
                user.setStatus("0");
                role = roleDAO.getRole(19);
                rolest.add(role);
                user.setRoles(rolest);
                user.setCompanyName("Доброном");
                if (user.getPassword() != null) {
...
//	}
    ...
    public List<User> getAllSuppliers() {
        return userDAO.getAllSuppliers();
    }
}
