...
<div class="container"> <h3>Менеджер международных маршрутов</h3></div>
<div class="container">
...
<a href = "<spring:url value="/main/logistics/international/add"/>">Создать маршрут</a>
			...
			<script	src="${pageContext.request.contextPath}/resources/js/internationalManager.js"></script>
