...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/infoCarrierList.css">
...
<body>
	...
	<script src='${pageContext.request.contextPath}/resources/js/infoCarrierList.js' type="module"></script>
</body>
</html>