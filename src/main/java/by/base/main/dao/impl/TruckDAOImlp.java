...
public class TruckDAOImlp implements TruckDAO{
	...
	private static final String queryGetList = "from Truck order by idtruck";
	@Override
	@Transactional
	...
	public Truck getTruckById(int id) {
		Session currentSession = sessionFactory.getCurrentSession();
		Truck object = currentSession.get(Truck.class, id);
		currentSession.flush();
		return object;
	}

	private static final String queryGetListObj = "from Truck t where numTruck=:setNumTruck";
	@Override
	@Transactional
	...
	private static final String queryGetListObjByUser = "from Truck where user_iduser=:user";
	@Override
	@Transactional
