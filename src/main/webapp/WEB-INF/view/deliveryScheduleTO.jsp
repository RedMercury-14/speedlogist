...
<body>
	...
	<div class="modal fade" id="createTempScheduleItemModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="createTempScheduleItemModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5 mt-0" id="createTempScheduleItemModalLabel">Создание временного графика поставок</h1>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<form id="createTempScheduleItemForm" action="">
					<div class="modal-body">
						<div class="inputs-container">
									...
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text custom-tooltip mr-2">
												<span class="font-weight-bold">Период действия графика:</span>
												<sup class="px-1 font-weight-bold text-danger">?</sup>
												<span class="tooltiptext">Временный график будет действовать ТОЛЬКО в указанный период</span>
											</div>
										</div>
										<div class="input-group-prepend">
