export const AG_GRID_LOCALE_RU = {
    ...
    // Group Column Filter
    groupFilterSelect: "Выбраное поле:",
    ...
    addToLabels: 'Добавить ${variable} к заголовкам',
    removeFromLabels: 'Удалить ${variable} из заголовков',
    ...
    copyWithGroupHeaders: 'Копировать с группой заголовков',
    cut: 'Вырезать',
    paste: "Вставить",
    ctrlV: "Ctrl+V",
    export: "Экспорт",
