...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/permissionСontrol.css">
</head>
<body>
	...
	<script charset="utf-8" src="${pageContext.request.contextPath}/resources/js/permissionСontrol.js" type="module"></script>
