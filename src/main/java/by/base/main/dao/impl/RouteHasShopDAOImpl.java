...
public class RouteHasShopDAOImpl implements RouteHasShopDAO{
	...
	private static final String queryGetList = "from RouteHasShop order by idorder";
	@Override
	@Transactional
	...
	private static final String queryGetListObj = "from RouteHasShop rhs where order=:order";
	@Override
	@Transactional	
	...
	private static final String queryGetListObjShop = "from RouteHasShop where shop_numshop=:numshop";
	@Override
	@Transactional
	...
	private static final String queryGetListObjShopAndRoute = "from RouteHasShop where shop_numshop=:numshop and route_idroute=:idroute";
	@Override
	@Transactional
